...
//    @Excel(name = "审核id")
     ...
     * 出票金额
     */
    @Excel(name = "开证金额", cellType = Excel.ColumnType.BIGINT, scale = 2)
...
//    @Excel(name = "协议编号")
     ...
     * 出票手续费
     */
    @Excel(name = "开证费用金额", cellType = Excel.ColumnType.BIGINT, scale = 2)
...
//    @Excel(name = "贴现金融机构")
     ...
     * 到期费用金额
     */
    @Excel(name = "到期费用金额", cellType = Excel.ColumnType.BIGINT, scale = 2)
