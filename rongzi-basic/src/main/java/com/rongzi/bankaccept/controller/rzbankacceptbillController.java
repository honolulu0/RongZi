...
public class rzbankacceptbillController extends BaseController
{
    ...
    @GetMapping(value = "/{managementId}")
    public AjaxResult getInfo(@PathVariable("managementId") String managementId)
    {
    ...
    public AjaxResult remove(@PathVariable String[] managementIds)
    {
        return toAjax(rzbankacceptbillService.deleterzbankacceptbillByManagementIds(managementIds));
    }
}
